...
public class CvteJiraDemo {
    ...
    private static URI jiraServerUri = URI.create("http://localhost:7777/rest/api/2/");
...
//            addIssueComplex(restClient, "FEEDBACK",DUE_DATE.toString());
    ...
    // 得到单一问题信息
    private static void getIssue(final JiraRestClient restClient, String issueKEY) throws InterruptedException, ExecutionException {
        try {
    ...
    private static void addIssue(final JiraRestClient restClient,
                                 String projectKEY, String issueName) throws InterruptedException,
            ExecutionException {
        try {

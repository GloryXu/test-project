package codes.chapter11.three.one;
...
public class ThreeLinkBinTree<E> {
    ...
    // 实现先序遍历
    public List<ThreeLinkBinTree.TreeNode> postIterator() {
        return postIterator(root);
    }

    private List<ThreeLinkBinTree.TreeNode> postIterator(ThreeLinkBinTree.TreeNode node) {
        List<ThreeLinkBinTree.TreeNode> list = new ArrayList<>();
    ...
    // 实现先序遍历
    public List<ThreeLinkBinTree.TreeNode> preIterator() {
        return preIterator(root);
    }

    private List<ThreeLinkBinTree.TreeNode> preIterator(ThreeLinkBinTree.TreeNode node) {
        List<ThreeLinkBinTree.TreeNode> list = new ArrayList<>();
        //处理根节点
        list.add(node);
        // 递归处理左子树

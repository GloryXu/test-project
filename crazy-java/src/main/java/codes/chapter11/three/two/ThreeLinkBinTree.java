package codes.chapter11.three.two;
...
public class ThreeLinkBinTree<E> {
    ...
    // 实现先序遍历
    public List<ThreeLinkBinTree.TreeNode> inIterator() {
        return inIterator(root);
    }

    private List<ThreeLinkBinTree.TreeNode> inIterator(ThreeLinkBinTree.TreeNode node) {
        List<ThreeLinkBinTree.TreeNode> list = new ArrayList<>();
        // 递归处理左子树
        if(node.left != null) {
